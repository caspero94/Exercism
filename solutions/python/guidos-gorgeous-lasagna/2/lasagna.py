# time the lasagna should be in the oven accoding to the cookbook.
...
def bake_time_remaining(elapsed_bake_time):
   ...
   Function that takes the actual minute the lasagna has been in the oven as
   an argument and returns how many minute the lasagna still needs to bake
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    This function takes two integers representing the number of lasagna layers and the time already spent baking
     and calculates the total elapsed minute spent cooking the lasagna.
    """
